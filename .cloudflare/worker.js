...
var init_conf = __esm({
  ".svelte-kit/output/server/chunks/conf.js"() {
    ...
    ({ VITE_APP_DEV_URL, VITE_APP_PUBLIC_URL } = { "VITE_APP_PUBLIC_URL": "https://kspotlight.fr/", "VITE_APP_DEV_URL": "http://localhost:5173/", "VITE_SPOTIFY_CLIENT_ID": "e618a49ff9514890aea2d1414a44b334", "VITE_SPOTIFY_CLIENT_SECRET": "4728493812064edc93c7a7551c839285", "VITE_SPOTIFY_REFRESH_TOKEN": "AQCxLXdCoL3U6L7Q1v-KwbBwFkMOhrMaaQN_MPSNHUg_0MV25DNpls8kGH2yq1CKgQ0JzRWGSqWA2whOjZpoaK9xupXVlkg0Cd9ZiaoPDpooPgJksOglJDZG_Sk8-S_w5s0", "VITE_SPOTIFY_BASIC": "ZTYxOGE0OWZmOTUxNDg5MGFlYTJkMTQxNGE0NGIzMzQ6NDcyODQ5MzgxMjA2NGVkYzkzYzdhNzU1MWM4MzkyODU=", "BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true });
    url = VITE_APP_PUBLIC_URL;
    config = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
      __proto__: null,
      description,
      homePageTitle,
      pageLinks,
...
// node_modules/.pnpm/registry.npmjs.org+dayjs@1.11.9/node_modules/dayjs/dayjs.min.js
var require_dayjs_min = __commonJS({
  "node_modules/.pnpm/registry.npmjs.org+dayjs@1.11.9/node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t, e) {
...
var void_element_names, defaultAttributes, Icon, Icon$1;
var init_Icon = __esm({
  ".svelte-kit/output/server/chunks/Icon.js"() {
    init_ssr();
...
var import_dayjs, defaultValue, activePage, PageLink, Copyright, truncate, CurrentPlaying, Footer, Navbar, Chevron_up, ChevronUp, BackToTop, Transition, Layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    init_Icon();
    defaultValue = pageLinks[0].name;
    activePage = writable(defaultValue);
    PageLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<ul class="flex list-none gap-4">${each(pageLinks, (link) => {
        return `<li class="text-sm"><a class="${"hover:text-primary transition-colors " + escape(
          $activePage === link.name ? "text-primary" : "text-zinc-800",
          true
        )}"${add_attribute("href", link.link, 0)}>${escape(link.name)}</a> </li>`;
      })}</ul>`;
    });
    Copyright = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const currentYear = (0, import_dayjs.default)().year();
      return `<p class="text-sm text-zinc-400">\xA9${escape(titleSite.toLowerCase())} - ${escape(currentYear)}</p>`;
    });
    truncate = (txt, min) => {
      if (!txt)
        return "";
    ...
    CurrentPlaying = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let data = {};
      console.log(data);
    ...
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_activePage = subscribe(activePage, (value) => $activePage = value);
      $$unsubscribe_activePage();
      return `<nav${add_attribute("class", `fixed bottom-5 left-2/4 z-10 mt-8 -translate-x-2/4 transform transition-transform duration-300 ease-in-out ${"translate-y-0"}`, 0)}><ul class="flex rounded-md bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur-3xl">${each(pageLinks, (link) => {
        return `<li><a class="${"relative block px-3 py-2 transition hover:text-primary " + escape(
          $activePage === link.name ? "text-primary" : "text-zinc-800",
          true
        )}"${add_attribute("href", link.link, 0)}>${escape(link.name)}</a> </li>`;
      })}</ul></nav>`;
    });
    Chevron_up = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    BackToTop = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return ` <button aria-label="back to top" class="${[
        "fixed right-4 bottom-5 z-10 flex cursor-pointer items-center justify-center rounded-md bg-white p-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 text-primary sm:right-4",
        "hidden"
      ].join(" ").trim()}">${validate_component(ChevronUp, "ChevronUp").$$render($$result, { size: "19" }, {}, {})}</button>`;
    });
    ...
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `${$$result.head += `<!-- HEAD_svelte-1pd7mjn_START --><script async src="https://analytics.umami.is/script.js" data-website-id="your-website-id-umami" data-svelte-h="svelte-1adevep"><\/script><!-- HEAD_svelte-1pd7mjn_END -->`, ""}  ${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})} ${validate_component(Transition, "BlurTransition").$$render($$result, { key: data.url }, {}, {
        default: () => {
          return `<main class="px-4 mx-auto max-w-2xl sm:px-8 lg:max-w-5xl lg:px-1">${slots.default ? slots.default({}) : ``} ${validate_component(BackToTop, "BackToTop").$$render($$result, {}, {}, {})}</main>`;
        }
...
var init_error_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_error.svelte.js"() {
    ...
    Error$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `${$$result.head += `<!-- HEAD_svelte-1bk8s80_START -->${$$result.title = `<title>Error ${escape(errorCode)}</title>`, ""}<meta name="description" content="Oops, an error has occurred."><meta property="og:title" content="${"Error " + escape(errorCode, true)}"><meta property="og:description" content="Oops, an error has occurred."><meta property="og:type" content="website"><meta name="twitter:title" content="${"Error " + escape(errorCode, true)}"><meta name="twitter:description" content="Oops, an error has occurred."><!-- HEAD_svelte-1bk8s80_END -->`, ""} <section class="mt-16 min-h-screen sm:mt-32"><span class="mx-auto my-7 block w-min rounded-md px-4 text-white drop-shadow-lg bg-primary py-[2px]">${escape(errorCode)}</span> <h1 class="text-center text-4xl font-bold tracking-tight text-primary sm:text-5xl">Error ${escape(errorCode)}</h1></section>`;
    });
  }
});
...
// node_modules/.pnpm/registry.npmjs.org+dayjs@1.11.9/node_modules/dayjs/locale/fr.js
var require_fr = __commonJS({
  "node_modules/.pnpm/registry.npmjs.org+dayjs@1.11.9/node_modules/dayjs/locale/fr.js"(exports, module) {
    !function(e, n) {
...
// .svelte-kit/output/server/chunks/PostCard.js
var import_dayjs2, import_fr, Chevron_right, ChevronRight, PostCard;
var init_PostCard = __esm({
  ".svelte-kit/output/server/chunks/PostCard.js"() {
    init_ssr();
    import_dayjs2 = __toESM(require_dayjs_min(), 1);
    import_fr = __toESM(require_fr(), 1);
    init_Icon();
    ...
    PostCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      import_dayjs2.default.locale("fr");
      let { posts } = $$props;
      if ($$props.posts === void 0 && $$bindings.posts && posts !== void 0)
        $$bindings.posts(posts);
      return `<div class="mt-28 flex flex-col gap-16 sm:px-8">${each(posts, (post) => {
        return `<article class="relative group"><span class="absolute -inset-x-4 -inset-y-6 -z-50 cursor-pointer rounded-md opacity-0 transition bg-hover_color -z-1 group-hover:scale-100 group-hover:opacity-50 sm:-inset-x-6"></span> <a href="${"/post/" + escape(post.slug, true)}" class="block"><time${add_attribute("data-time", post.date, 0)} class="text-sm text-zinc-400">${escape((0, import_dayjs2.default)(post.date).format("d MMMM YYYY"))}</time> <h2 class="my-3 text-base font-semibold tracking-tight text-zinc-800 transition-colors group-hover:text-primary">${escape(post.title)}</h2> <p class="mt-3 text-sm text-zinc-600">${escape(post.description)}</p> <span class="mt-3 flex items-center gap-1 text-sm text-primary">Read
					${validate_component(ChevronRight, "ChevronRight").$$render($$result, { size: "14" }, {}, {})} </span></a> </article>`;
      })}</div>`;
    });
  }
});
...
var init_SummaryCard = __esm({
  ".svelte-kit/output/server/chunks/SummaryCard.js"() {
    ...
    SummaryCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="mt-16 sm:mt-32 sm:px-8"><header class="max-w-2xl"><h1 class="text-4xl font-bold tracking-tight text-primary sm:text-5xl">${escape(title)}</h1> <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">${escape(description2)}</p></header></div>`;
    });
  }
});
...
// .svelte-kit/output/server/chunks/celebrating-half-a-century-of-hip-hop.js
var celebrating_half_a_century_of_hip_hop_exports = {};
__export(celebrating_half_a_century_of_hip_hop_exports, {
  _: () => __vite_glob_0_0
});
var Image, metadata, Celebrating_half_a_century_of_hip_hop, __vite_glob_0_0;
var init_celebrating_half_a_century_of_hip_hop = __esm({
  ".svelte-kit/output/server/chunks/celebrating-half-a-century-of-hip-hop.js"() {
    init_ssr();
    Image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.src === void 0 && $$bindings.src && src !== void 0)
        $$bindings.src(src);
      return `<figure><img${add_attribute("alt", alt, 0)}></figure>`;
    });
    metadata = {
    ...
    Celebrating_half_a_century_of_hip_hop = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1 id="celebrating-half-a-century-of-hip-hop" data-svelte-h="svelte-1re0v1v">Celebrating Half a Century of Hip-Hop</h1> ${validate_component(Image, "Image").$$render(
        $$result,
        {
          src: "https://www.rollingstone.com/wp-content/uploads/2022/05/210603_200rapalbums_FINAL.jpg",
          alt: "hello"
        },
        {},
        {}
...
<ul data-svelte-h="svelte-1hkgng"><li><a href="https://www.youtube.com/watch?v=rKTUAESacQM&ab_channel=dutchmanmm" rel="nofollow">Rapper\u2019s Delight</a> - The Sugarhill Gang (1979): The song that introduced hip-hop to the world.</li> <li><a href="https://www.youtube.com/watch?v=9J3lwZjHenA&ab_channel=TommyBoy" rel="nofollow">Planet Rock</a> - Afrika Bambaataa (1982): A fusion of electronic and hip-hop, pioneering a new sound.</li> <li><a href="https://www.youtube.com/watch?v=PobrSpMwKk4&ab_channel=SugarhillRecords" rel="nofollow">The Message</a> - Grandmaster Flash and the Furious Five (1982): A reflection of urban life and its challenges.</li> <li><a href="https://www.youtube.com/watch?v=qZuxPKUVGiw&ab_channel=N.W.A" rel="nofollow">Fuck tha Police</a> - N.W.A (1988): A bold statement against police brutality and racial profiling.</li> <li><a href="https://www.youtube.com/watch?v=f8cHxydDb7o&ab_channel=QueenLatifahVEVO" rel="nofollow">U.N.I.T.Y.</a> - Queen Latifah (1993): An anthem of female empowerment in a male-dominated industry.</li> <li><a href="https://www.youtube.com/watch?v=PBwAxmrE194&ab_channel=WuTangClanVEVO" rel="nofollow">C.R.E.A.M</a> - Wu-Tang Clan (1994): A raw depiction of life in the projects and the allure of money.</li> <li><a href="https://www.youtube.com/watch?v=z5rRZdiu1UE&ab_channel=BeastieBoysVEVO" rel="nofollow">Sabotage</a> - Beastie Boys (1994): A testament to the group\u2019s versatility and rock-infused style.</li> <li><a href="https://www.youtube.com/watch?v=JaqLOsO6dTw&ab_channel=IAMOfficiel" rel="nofollow">Demain, c\u2019est loin</a> - IAM (1996): A French hip-hop masterpiece, proving the genre\u2019s global appeal.</li> <li><a href="https://www.youtube.com/watch?v=_JZom_gVfuw&ab_channel=TheNotoriousB.I.G." rel="nofollow">Juicy</a> - The Notorious B.I.G. (1997): A rags-to-riches tale from one of hip-hop\u2019s greatest storytellers.</li> <li><a href="https://www.youtube.com/watch?v=_CL6n0FJZpk&ab_channel=DrDreVEVO" rel="nofollow">Still D.R.E.</a> - Dr. Dre (1999): A West Coast anthem that solidified Dre\u2019s legacy in the industry.</li> <li><a href="https://www.youtube.com/watch?v=L53gjP-TtGE&ab_channel=KanyeWestVEVO" rel="nofollow">Power</a> - Kanye West (2010): A track showcasing West\u2019s unique style and his commentary on fame.</li> <li><a href="https://www.youtube.com/watch?v=Z-48u_uWMHY&ab_channel=KendrickLamarVEVO" rel="nofollow">Alright</a> - Kendrick Lamar (2015): A modern-day anthem of hope and resilience in the face of adversity.</li></ul> <p data-svelte-h="svelte-erzov2">As we celebrate these tracks and many others, we recognize the power of hip-hop to tell stories, challenge norms, and inspire generations. Here\u2019s to another 50 years of beats, bars, and breakthroughs!</p>`;
    });
    __vite_glob_0_0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
      __proto__: null,
      default: Celebrating_half_a_century_of_hip_hop,
      metadata
    }, Symbol.toStringTag, { value: "Module" }));
  }
});

// .svelte-kit/output/server/chunks/the-best-pop-album-2022.js
var the_best_pop_album_2022_exports = {};
__export(the_best_pop_album_2022_exports, {
  _: () => __vite_glob_0_1
});
var YoutubeEmbed, metadata2, The_best_pop_album_2022, __vite_glob_0_1;
var init_the_best_pop_album_2022 = __esm({
  ".svelte-kit/output/server/chunks/the-best-pop-album-2022.js"() {
    init_ssr();
    YoutubeEmbed = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { videoLink } = $$props;
      if ($$props.videoLink === void 0 && $$bindings.videoLink && videoLink !== void 0)
        $$bindings.videoLink(videoLink);
      return `${`<div class="my-14 h-80 w-full animate-pulse rounded-md bg-gray-200"></div>`} <iframe${add_attribute("class", "hidden", 0)} width="100%" height="315"${add_attribute("src", videoLink, 0)} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
    });
    metadata2 = {
      "title": "Renaissance by Beyonc\xE9: Pop's Crown Jewel of 2022",
      "description": "Unraveling the magic behind 2022's standout pop album.",
      "date": "2023-8-14",
      "published": true
    };
    The_best_pop_album_2022 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1 id="beyonc\xE9s-renaissance-2022s-pop-masterpiece" data-svelte-h="svelte-1uo0bdz">Beyonc\xE9\u2019s \u201CRenaissance\u201D: 2022\u2019s Pop Masterpiece</h1> ${validate_component(YoutubeEmbed, "YoutubeEmbed").$$render(
        $$result,
        {
          videoLink: "https://www.youtube.com/embed/iz1rIp1-b-Y"
        },
        {},
        {}
      )} <p data-svelte-h="svelte-ms35jr">In a year teeming with musical talent, Beyonc\xE9\u2019s \u201CRenaissance\u201D reigned supreme. Here\u2019s why:</p> <p data-svelte-h="svelte-luk2je">Sonic Innovation: A perfect blend of classic and experimental, setting a new bar for pop.</p> <p data-svelte-h="svelte-1wr0ucm">Lyrical Depth: Beyond catchy tunes, it offered stories of empowerment and resilience.</p> <p data-svelte-h="svelte-jyc8vz">Cultural Commentary: More than music, it addressed societal issues, making it a timely masterpiece.</p> <p data-svelte-h="svelte-u1x4g1">Artistic Excellence: Beyonc\xE9\u2019s commitment shone through every track, solidifying its top spot.</p> <p data-svelte-h="svelte-ut5ruj">In essence, \u201CRenaissance\u201D wasn\u2019t just music; it was a statement, making it 2022\u2019s pop pinnacle.</p>`;
    });
    __vite_glob_0_1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
      __proto__: null,
      default: The_best_pop_album_2022,
      metadata: metadata2
    }, Symbol.toStringTag, { value: "Module" }));
  }
});

// .svelte-kit/output/server/entries/pages/post/_slug_/_page.ts.js
...
async function load3({ params }) {
  try {
    const post = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../posts/celebrating-half-a-century-of-hip-hop.md": () => Promise.resolve().then(() => (init_celebrating_half_a_century_of_hip_hop(), celebrating_half_a_century_of_hip_hop_exports)).then((n) => n._), "../../../posts/the-best-pop-album-2022.md": () => Promise.resolve().then(() => (init_the_best_pop_album_2022(), the_best_pop_album_2022_exports)).then((n) => n._) }), `../../../posts/${params.slug}.md`);
    return {
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/post/_slug_/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `${$$result.head += `<!-- HEAD_svelte-1sqflif_START -->${$$result.title = `<title>${escape(data.meta.title)}</title>`, ""}<meta name="description"${add_attribute("content", data.meta.description, 0)}><meta property="og:title"${add_attribute("content", data.meta.title, 0)}><meta property="og:description"${add_attribute("content", data.meta.description, 0)}><meta property="og:url"${add_attribute("content", url2, 0)}><meta property="og:type" content="article"><meta name="twitter:title"${add_attribute("content", data.meta.title, 0)}><meta name="twitter:description"${add_attribute("content", data.meta.description, 0)}><!-- HEAD_svelte-1sqflif_END -->`, ""} <article class="mx-auto prose-img:my-14 mt-16 prose-img:h-full prose-img:w-full max-w-2xl prose-img:rounded-md prose-img:opacity-0 prose-img:shadow-2xl prose-img:transition-opacity prose prose-headings:text-primary prose-a:text-primary lg:mt-32">${validate_component(data.content || missing_component, "svelte:component").$$render($$result, {}, {}, {})}</article>`;
    });
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    universal_id3 = "src/routes/post/[slug]/+page.ts";
    imports4 = ["_app/immutable/nodes/3.ba0d196c.js", "_app/immutable/chunks/preload-helper.a4192956.js", "_app/immutable/chunks/control.f5b05b5f.js", "_app/immutable/chunks/scheduler.5cba145a.js", "_app/immutable/chunks/index.1b9f201c.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/posts/_page.ts.js
  ...
  ".svelte-kit/output/server/entries/pages/posts/_page.svelte.js"() {
    ...
    Page3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${$$result.head += `<!-- HEAD_svelte-1oo9x60_START -->${$$result.title = `<title>${escape(titleSite2)}</title>`, ""}<meta name="description"${add_attribute("content", postsPageDesc2, 0)}><meta property="og:title"${add_attribute("content", titleSite2, 0)}><meta property="og:description"${add_attribute("content", postsPageDesc2, 0)}><meta property="og:url"${add_attribute("content", "https://kspotlight.fr/", 0)}><meta property="og:type" content="website"><meta name="twitter:title"${add_attribute("content", titleSite2, 0)}><meta name="twitter:description"${add_attribute("content", postsPageDesc2, 0)}><!-- HEAD_svelte-1oo9x60_END -->`, ""} ${validate_component(SummaryCard, "PostSummaryCard").$$render(
        ...
        {},
        {}
      )} ${validate_component(PostCard, "PostCard").$$render($$result, { posts }, {}, {})}`;
    });
  }
});
...
var index5, component_cache5, component5, universal_id4, imports5, stylesheets5, fonts5;
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_page_ts3();
    index5 = 4;
...
// .svelte-kit/output/server/entries/pages/resources/_page.ts.js
var page_ts_exports4 = {};
__export(page_ts_exports4, {
  load: () => load5
});
async function load5({ fetch: fetch2 }) {
  const response = await fetch2("/data.json");
  ...
  ".svelte-kit/output/server/entries/pages/resources/_page.svelte.js"() {
    ...
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${validate_component(SummaryCard, "PageSummaryCard").$$render(
        ...
        {
          title: resPageTitle2,
          description: resPageDesc2
        },
        {},
        {}
      )} <div class="mt-16 flex flex-col sm:px-8">${each(Object.values(data.props), (category) => {
        return `<div class="my-7"><h2 class="text-sm text-zinc-800">${escape(category.title)}</h2> ${each(category.data, (item) => {
          return `<div class="relative my-10 group"><span class="absolute -inset-x-4 -inset-y-6 -z-50 cursor-pointer rounded-md opacity-0 transition bg-hover_color -z-1 group-hover:scale-100 group-hover:opacity-50 sm:-inset-x-6"></span> <h3><a class="text-base font-semibold tracking-tight text-zinc-800"${add_attribute("href", item.link, 0)} target="_blank">${escape(item.title)}</a></h3> <p class="mt-2 text-sm text-zinc-600">${escape(item.description)}</p> </div>`;
        })} </div>`;
      })}</div>`;
    });
  }
...
var index6, component_cache6, component6, universal_id5, imports6, stylesheets6, fonts6;
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_page_ts4();
    index6 = 5;
...
// .svelte-kit/output/server/entries/endpoints/api/now_playing/_server.ts.js
...
var getAccessToken, currentlyPlayingSong;
var init_server_ts = __esm({
  ".svelte-kit/output/server/entries/endpoints/api/now_playing/_server.ts.js"() {
    init_chunks();
    getAccessToken = async () => {
      const refresh_token = "AQCxLXdCoL3U6L7Q1v-KwbBwFkMOhrMaaQN_MPSNHUg_0MV25DNpls8kGH2yq1CKgQ0JzRWGSqWA2whOjZpoaK9xupXVlkg0Cd9ZiaoPDpooPgJksOglJDZG_Sk8-S_w5s0";
      const response = await fetch("https://accounts.spotify.com/api/token", {
        method: "POST",
        headers: {
          Authorization: `Basic ${"ZTYxOGE0OWZmOTUxNDg5MGFlYTJkMTQxNGE0NGIzMzQ6NDcyODQ5MzgxMjA2NGVkYzkzYzdhNzU1MWM4MzkyODU="}`,
...
// .svelte-kit/output/server/entries/endpoints/api/posts/_server.ts.js
...
async function getPosts() {
  let posts = [];
  const paths = /* @__PURE__ */ Object.assign({ "/src/posts/celebrating-half-a-century-of-hip-hop.md": __vite_glob_0_0, "/src/posts/the-best-pop-album-2022.md": __vite_glob_0_1 });
  for (const path in paths) {
    const file = paths[path];
    const slug = path.split("/").at(-1)?.replace(".md", "");
    if (file && typeof file === "object" && "metadata" in file && slug) {
      const metadata3 = file.metadata;
      const post = { ...metadata3, slug };
...
var init_server_ts2 = __esm({
  ".svelte-kit/output/server/entries/endpoints/api/posts/_server.ts.js"() {
    init_celebrating_half_a_century_of_hip_hop();
    init_the_best_pop_album_2022();
    init_chunks();
  }
});
  ...
  async fetch(req, env, context) {
    ...
    if (url2.pathname.startsWith(app_path)) {
      ...
      if (is_error(res.status))
        return res;
      const cache_control = url2.pathname.startsWith(app_path + "immutable/") ? "public, immutable, max-age=31536000" : "no-cache";
